...
## ✅ 完了済み作業
  ...
  - **2026-09-17: 安全原則2を実態に合わせて修正（本番反映）**
    - 「人の確認を必ず挟む」→「人の確認を、必要なところに残す」
    - OhiScanは自信が高いものが仕組みで貼付し、要確認だけ人が見る。医療書類の完成は人が押す、は維持
    - 対象: `safety/`、トップ、`solutions/ohiscan/`、`article6/`、`article3/`、`article/`
    - バックアップ: `_backup/*_backup_20260917_090707.*`
